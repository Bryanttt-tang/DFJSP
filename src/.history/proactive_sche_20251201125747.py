...
def train_perfect_knowledge_agent(jobs_data, machine_list, arrival_times, total_timesteps=100000, 
    ...
    for init_idx in range(num_initializations):
        ...
        model = MaskablePPO(
            ...
            batch_size=512,            # Good batch size for stability
            n_epochs=5,               # ⭐ More epochs = better learning per rollout
...
def main():
    ...
    rule_based_timesteps = 100000  # Same as reactive - needs to explore all rule combos
