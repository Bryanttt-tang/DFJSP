...
def train_static_agent(jobs_data, machine_list, total_timesteps=300000, reward_mode="makespan_increment", learning_rate=3e-4):
    ...
    model = MaskablePPO(
        ...
        n_steps=25,               # Keep same: 8 envs × 25 = 200 samples per rollout
        batch_size=50,            # INCREASED: 2048/50 = 40 minibatches (was 16)
        n_epochs=2,                # REDUCED: standard PPO uses 3-4 (was 10)
