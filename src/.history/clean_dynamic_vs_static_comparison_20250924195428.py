...
ENHANCED_JOBS_DATA = collections.OrderedDict({
    ...
    7: [{'proc_times': {'M0': 6, 'M2': 7}}, {'proc_times': {'M1': 5}}, {'proc_times': {'M2': 4, 'M0': 3}}],
    8: [{'proc_times': {'M1': 8, 'M2': 5}}, {'proc_times': {'M0': 4, 'M2': 6}}, {'proc_times': {'M1': 3}}],
    9: [{'proc_times': {'M0': 5, 'M1': 7}}, {'proc_times': {'M2': 6}}, {'proc_times': {'M1': 4, 'M0': 2}}],
})
...
def plot_training_metrics():
    ...
    if TRAINING_METRICS['policy_loss'] and TRAINING_METRICS['value_loss']:
        ...
        axes[1, 1].plot(timesteps[:min_len], TRAINING METRICS['policy_loss'][:min_len], 'r-', linewidth=2, label='Policy Loss')
    ...
    for scenario_idx in range(len(test_scenarios)):
        ...
        if milp_makespan != float('inf'):
            ...
            methods_to_plot = [
                ...
                ('Static RL (on dynamic scenario)', schedules['Static RL (on dynamic scenario)']),
