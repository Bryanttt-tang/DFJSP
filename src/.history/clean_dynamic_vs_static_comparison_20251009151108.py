...
def plot_training_metrics():
    ...
    # Plot 3: Policy Loss over Rollouts (Middle Left)
    if TRAINING_METRICS['policy_loss']:
        policy_loss = TRAINING_METRICS['policy_loss'][:num_rollouts]  # Should already be same length
        
        axes[1, 0].plot(rollout_numbers, policy_loss, 'r-', linewidth=2, alpha=0.7, label='Policy Loss')
        axes[1, 0].legend()
