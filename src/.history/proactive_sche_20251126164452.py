...
def train_perfect_knowledge_agent(jobs_data, machine_list, arrival_times, total_timesteps=100000, 
    ...
    for init_idx in range(num_initializations):
        ...
        model = MaskablePPO(
            ...
            n_steps=1024,              # ⭐ Larger rollout for better value estimates
            ...
            ent_coef=0.02,           # ⭐ VERY LOW entropy (deterministic scenario!)
            ...
            policy_kwargs=dict(
                net_arch=dict(
                    ...
                    vf=[512, 256, 256]     # Separate value network
                ),
...
def train_proactive_agent(jobs_data, machine_list, initial_jobs=5, arrival_rate=0.08, 
    ...
    model = MaskablePPO(
        ...
        n_steps=2048,               # Increased from 1024 - match other RL methods
        batch_size=1024,            # Increased from 256 for more stable gradients
...
def main():
    ...
    print("\n1. TRAINING SETUP")
    print("-" * 50)
    perfect_timesteps = 800000    # Perfect knowledge with MULTIPLE INITIALIZATIONS
    dynamic_timesteps = 100000  # Increased from 300k - Reactive needs more time
    proactive_timesteps = 1200000  # Increased from 300k - Proactive needs even more (prediction + scheduling)
    rule_based_timesteps = 800000  # Same as reactive - needs to explore all rule combos
    static_timesteps = 300000    # Increased for better learning
    learning_rate = 3e-4         # Optimized learning rate for PPO
