...
def calculate_regret_analysis(optimal_makespan, methods_results, benchmark_name="MILP Optimal"):
    ...
    # Check if hierarchy is as expected (only if all required keys exist)
    if ('Perfect Knowledge RL' in regret_results and 
        'Reactive RL' in regret_results and 
        'Static RL (dynamic)' in regret_results):
        expected_order = (
