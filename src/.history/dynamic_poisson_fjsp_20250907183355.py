...
def plot_three_method_comparison(schedules_data, save_path=None):
    """
...
if __name__ == "__main__":
    ...
    arrival_rate = 0.3        # Poisson arrival rate for jobs 3-6
    ...
    static_rl_model.learn(total_timesteps=100000)
    ...
    print("-" * 50)
    plot_three_method_comparison(schedules_data, save_path="three_method_comparison.png")
    ...
    return {
        ...
        'dynamic_rl_makespan': dynamic_rl_makespan,
        'static_rl_makespan': static_rl_makespan,
