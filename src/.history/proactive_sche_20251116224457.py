...
def edd_heuristic(jobs_data, machine_list, arrival_times):
    ...
    Sequencing: EDD (earliest due date first)
    ...
    """
    return simple_list_scheduling(jobs_data, machine_list, arrival_times, "EDD", "MIN")
...
def best_heuristic(jobs_data, machine_list, arrival_times):
    ...
    Compares: 6 sequencing rules × 3 routing rules = 18 total combinations
    - Sequencing: FIFO, LIFO, SPT, LPT, EDD, MWKR
    - Routing: MIN, MINC, LEAST_LOADED
    
    Returns: (makespan, schedule) of the best-performing combination
    """
    print(f"  Comparing all sequencing × routing combinations with arrival times: {arrival_times}")
