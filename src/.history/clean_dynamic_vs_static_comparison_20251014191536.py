...
class PoissonDynamicFJSPEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # In schedule builder mode, event time should NOT advance during scheduling actions
        # Job arrivals are only revealed when event_time explicitly passes their arrival time
        # This happens through WAIT actions or when scheduling naturally advances the event frontier
