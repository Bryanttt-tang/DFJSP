...
class PoissonDynamicFJSPEnv(gym.Env):
    ...
    def _advance_to_next_arrival(self):
        ...
        new_arrivals = self._update_event_time_and_arrivals(next_arrival_time)

        return next_arrival_time, new_arrivals
    ...
    def step(self, action):
        ...
        # CRITICAL FIX: DO NOT automatically advance event_time after scheduling!
        # event_time should only advance when agent explicitly WAITs.
        # This allows agent to continue scheduling multiple operations at current event_time
        # (e.g., schedule J0 on M0, then J1 on M1, both at t=0)
        # Only reveal jobs that arrive by the start_time of this operation
