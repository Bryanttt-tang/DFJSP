...
class StaticFJSPEnv(gym.Env):
    ...
    def _reset_state(self):
        ...
        self.current_makespan = 0.0  # Use makespan like test3_backup.py
        self.operations_scheduled = 0
        self.episode_step = 0
        self.max_episode_steps = self.total_operations * 2  # Like test3_backup.py
        self.num_completed_jobs = 0
        
        # Initialize arrived jobs (all jobs available at t=0 for static)
