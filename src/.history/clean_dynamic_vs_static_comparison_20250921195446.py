...
def evaluate_dynamic_on_dynamic(dynamic_model, jobs_data, machine_list, arrival_times, reward_mode="makespan_increment"):
    ...
    # Create a fresh PoissonDynamicFJSPEnv with specific arrival times
    # This maintains environment consistency with training
    test_env = PoissonDynamicFJSPEnv(
        ...
        reward_mode=reward_mode,
        seed=None  # Don't use seed to avoid randomization
    )
    ...
    # Override with specific arrival times AFTER reset
