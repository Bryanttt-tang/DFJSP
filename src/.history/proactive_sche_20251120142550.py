...
def main():
    ...
    for i, scenario in enumerate(test_scenarios):
        ...
        # Try OR-Tools CP-SAT first (usually faster for scheduling), fallback to MILP if fails
        ...
        if optimal_makespan != float('inf'):
            ...
            # Fallback to MILP with Gurobi
            print(f"    OR-Tools failed, trying MILP with Gurobi...")
