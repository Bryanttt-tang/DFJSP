...
class DispatchingRuleFJSPEnv(gym.Env):
    ...
    def _get_ready_operations(self):
        ...
        3. It's the next operation in the job
        4. Job is ready at current event_time (precedence + arrival satisfied)
        """
        ready_ops = []
        ...
        for job_id in self.arrived_jobs:
            ...
            if op_idx < len(self.jobs[job_id]):
                ...
                # EVENT-DRIVEN: Only schedule if ready at current event_time
