...
class PoissonDynamicFJSPEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # SCHEDULING ACTIONS DO NOT ADVANCE EVENT TIME
        # Event time represents the simulation frontier and only advances through:
        # 1. WAIT actions (explicit time advancement)
        # 2. When we explicitly need to reveal arrivals
        # 
        # Jobs arriving between current event_time and start_time are NOT revealed
        # until the event_time actually passes their arrival time
