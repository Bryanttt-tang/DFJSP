...
class PoissonDynamicFJSPEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if job_idx is None:
            ...
            # print('arrived jobs:', self.arrived_jobs)
            # print('new arrivals this step:', new_arrivals)
            # print('current_event_time:', self.event_time)
            # print('machine next free times:', self.machine_next_free)
            # print('new_event_time:', new_event_time)
            ...
            if not new_arrivals and not future_arrivals_possible and not np.any(self.action_masks()[:-1]):
