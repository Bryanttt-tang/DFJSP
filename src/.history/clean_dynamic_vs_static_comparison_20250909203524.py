...
def train_dynamic_agent(jobs_data, machine_list, initial_jobs=3, arrival_rate=0.08, total_timesteps=200000, reward_mode="combined_makespan_utilization"):
    ...
    print("🎯 ENHANCED TRAINING FOCUS:")
    print("  • STRONGER machine utilization penalties (5x vs 3x) - reduces empty spaces")
    print("  • ENHANCED future-aware scheduling rewards (3x vs 1.5x)")
    print("  • INCREASED dynamic adaptation bonuses (12x vs 8x) for new arrivals")
    print("  • BETTER load balancing incentives (4x vs 2x)")
    print("  • DEEPER neural network (1024→512→512→256→128) for complex patterns")
    print("  • HIGHER timesteps (500k vs 300k) for better Poisson learning")
    print("  • MORE arrival scenarios (arrival_rate=0.12 vs 0.1)")
