...
def test_observation_sensitivity():
    ...
    # Create two identical environments with different arrival patterns
    env1 = PoissonDynamicFJSPEnv(
        ENHANCED_JOBS_DATA, MACHINE_LIST,
        initial_jobs=[0, 1],  # Start with 2 jobs
        arrival_rate=0.0,  # No further arrivals
    ...
    # Manually set different arrival times for remaining jobs
    env1.arrival_times = {0: 0, 1: 0, 2: 5.0, 3: 10.0, 4: 15.0, 5: 20.0, 6: 25.0}
    env2.arrival_times = {0: 0, 1: 0, 2: 2.0, 3: 4.0, 4: 6.0, 5: 8.0, 6: 10.0}
