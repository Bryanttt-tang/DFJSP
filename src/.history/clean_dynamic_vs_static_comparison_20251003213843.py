...
def train_dynamic_agent(jobs_data, machine_list, initial_jobs=5, arrival_rate=0.08, total_timesteps=500000, reward_mode="makespan_increment", learning_rate=3e-4):
    ...
    model = MaskablePPO(
        ...
        batch_size=528,            # IDENTICAL across all RL methods
...
def main():
    ...
    print("\n1. TRAINING SETUP")
    print("-" * 50)
    perfect_timesteps = 400000    # Perfect knowledge needs less training
    ...
    dynamic_model = train_dynamic_agent(
        ...
        total_timesteps=dynamic_timesteps, reward_mode="makespan_increment", learning_rate=1e-4
    )
    ...
    for i, scenario in enumerate(test_scenarios):
        ...
        perfect_model = train_perfect_knowledge_agent(
            ...
            reward_mode="makespan_increment", learning_rate=1e-4
        )
        if i == 0:
