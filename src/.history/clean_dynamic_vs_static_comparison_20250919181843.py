...
class PoissonDynamicFJSPEnv(gym.Env):
    ...
    def _reset_state(self):
        ...
        # Note: Poisson arrival generation moved to reset() method for episode diversity
    ...
    def reset(self, seed=None, options=None):
        ...
        # CRITICAL FIX: Generate NEW Poisson arrivals for each episode
        # This ensures training diversity across episodes
