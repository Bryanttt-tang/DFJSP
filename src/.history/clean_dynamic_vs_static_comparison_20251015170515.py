...
def train_static_agent(jobs_data, machine_list, total_timesteps=300000, reward_mode="makespan_increment", learning_rate=3e-4):
    ...
    model = MaskablePPO(
        ...
        n_steps=100,              # IDENTICAL across all RL methods
        batch_size=25,            # IDENTICAL across all RL methods
...
def main():
    ...
    print("\n1. TRAINING SETUP")
    print("-" * 50)
    perfect_timesteps = 10000    # Perfect knowledge needs less training
    dynamic_timesteps = 300000   # Increased for better learning with integer timing  
    static_timesteps = 10000    # Increased for better learning
