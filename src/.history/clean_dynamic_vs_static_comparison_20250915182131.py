...
def train_static_agent(jobs_data, machine_list, total_timesteps=300000, reward_mode="combined_makespan_utilization"):
    ...
    model = MaskablePPO(
        ...
        ent_coef=0.01,
        policy_kwargs=dict(
            net_arch=[512, 256, 256, 128],  # Deeper for 21-job complexity
...
def train_dynamic_agent(jobs_data, machine_list, initial_jobs=5, arrival_rate=0.08, total_timesteps=500000, reward_mode="combined_makespan_utilization"):
    ...
    model = MaskablePPO(
        ...
        policy_kwargs=dict(
            net_arch=[512, 512, 256, 256, 128],  # DEEPER network for 21-job complexity
            activation_fn=torch.nn.ReLU,
...
def main():
    ...
    static_timesteps = 50000    # Reduced for smaller 7-job dataset test
