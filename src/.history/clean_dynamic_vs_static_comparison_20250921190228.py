...
def main():
    ...
    print(f"Using scenario 1 for Perfect Knowledge RL training: {first_scenario_arrivals}")
    print(f"Note: Perfect Knowledge RL trains on specific scenario but will be evaluated on all 10 test scenarios")
    ...
    for scenario_idx in range(len(test_scenarios)):
        ...
        if scenario_idx < len(gantt_scenarios_data):
            ...
            perfect_makespan, perfect_schedule = evaluate_perfect_knowledge_on_scenario(
                perfect_model, ENHANCED_JOBS_DATA, MACHINE_LIST, arrival_times)
    ...
    # Skip the old static RL comparison code
    fig_static, axes_static = plt.subplots(2, 1, figsize=(18, 8)) if False else None
    ...
    # Step 9: Create Gantt Charts for All 10 Test Scenarios
    print(f"\n9. GANTT CHARTS FOR ALL 10 TEST SCENARIOS")
    print("-" * 60)
