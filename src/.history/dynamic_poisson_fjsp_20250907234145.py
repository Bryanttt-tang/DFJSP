...
if __name__ == "__main__":
    ...
    static_rl_makespan, static_rl_schedule = evaluate_poisson_agent_fixed(
        static_rl_model, ENHANCED_JOBS_DATA, MACHINE_LIST,
        consistent_arrival_times, debug=False
    )
    ...
    print("NOTE: Static RL trained on static but tested on Poisson arrivals")
