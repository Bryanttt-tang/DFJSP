...
class StaticFJSPEnv(PerfectKnowledgeFJSPEnv):
    """
    Static FJSP Environment where all jobs are available at time 0.
    Simply inherits from PerfectKnowledgeFJSPEnv with all arrival times set to 0.
    """
    ...
    def __init__(self, jobs_data, machine_list, reward_mode="makespan_increment", seed=None):
        ...
        super().__init__(
            ...
            arrival_times=static_arrival_times,
