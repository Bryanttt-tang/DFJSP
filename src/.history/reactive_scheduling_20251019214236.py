...
class PoissonDynamicFJSPEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # Start time must respect: machine availability, job precedence, and event time visibility
        # Note: event_time CAN be > machine_available_time and > job_ready_time in valid cases
        # (e.g., when WAIT action advanced time, or when scheduling on a machine that was busy)
