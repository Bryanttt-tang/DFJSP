...
def main():
    ...
    # Use simplified integer arrival times for better learning
    print("Using simplified integer arrival times for evaluation...")
    test_scenarios = [{
        'scenario_id': 0,
        'arrival_times': {0: 0, 1: 0, 2: 0, 3: 4, 4: 8, 5: 12, 6: 16},  # Integer arrivals
        'initial_jobs': [0, 1, 2],
        'arrival_rate': arrival_rate,
        'seed': 42
    }]
