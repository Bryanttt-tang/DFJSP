...
class PoissonDynamicFJSPEnv(gym.Env):
    ...
    def _update_event_time_and_arrivals(self, new_event_time):
        ...
        print(f"  DEBUG _update_event_time: {old_event_time} -> {self.event_time}, newly_arrived: {sorted(newly_arrived)}")
    ...
    def _get_next_event_time(self):
        ...
        print(f"  DEBUG _get_next_event_time: event_time={self.event_time}, next_arrival={next_arrival_time}, next_machine_completion={next_machine_completion}")
        print(f"  DEBUG machine states: {dict(self.machine_next_free)}")
        print(f"  DEBUG arrived_jobs: {sorted(self.arrived_jobs)}")
        print(f"  DEBUG job_arrival_times: {dict(self.job_arrival_times)}")
        ...
        print(f"  DEBUG _get_next_event_time result: {result}")
        return result
