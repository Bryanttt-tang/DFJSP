...
def canonicalize_state(next_ops, machine_next_free, job_ready_time, current_time, time_unit=1, cap=None):
    """
    Minimal canonical state as tuple of tuples (hashable) following policy-iter2.py approach.
    This is the compact observation space: (next_ops, machine_next_free, job_ready_time)
    sufficient for Markov property in event-driven no-queue scheduling.
    """
