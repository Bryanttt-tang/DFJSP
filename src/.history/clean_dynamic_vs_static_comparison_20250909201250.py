...
class PoissonDynamicFJSPEnv(gym.Env):
    ...
    def __init__(self, jobs_data, machine_list, initial_jobs=5, arrival_rate=0.05, 
        ...
        # Dynamic action space: each job can have at most one ready operation
        # Action = index into self.valid_actions list of (job_id, machine_name) pairs
    ...
    def _advance_time_to_next_arrival(self):
        ...
        if self.next_arrival_events:
            next_arrival_time, next_job_id = self.next_arrival_events[0]
    ...
    def step(self, action):
        """Execute one step in the environment using dynamic action space."""
        self.episode_step += 1
        ...
        # Validate action using dynamic action space (NO DECODING NEEDED!)
