...
NUM_FUTURE_JOBS = 35   # Jobs arriving dynamically
...
def main():
    ...
    dynamic_timesteps = 700000   # Increased for better learning with integer timing 
    proactive_timesteps = 700000 
    static_timesteps = 300000    # Increased for better learning
    learning_rate = 5e-4         # Optimized learning rate for PPO (was 10e-4)
