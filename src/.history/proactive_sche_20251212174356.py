...
def main():
    ...
    proactive_timesteps = 10000000  # Increased from 300k - Proactive needs even more (prediction + scheduling)
    rule_based_timesteps = 10000000  # Same as reactive - needs to explore all rule combos
