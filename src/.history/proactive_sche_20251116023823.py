...
class DispatchingRuleFJSPEnv(gym.Env):
    """
    Dynamic FJSP Environment where actions select DISPATCHING RULES instead of (job, machine) pairs.
    
    Inspired by literature that learns to select among predefined heuristic rules.
    ...
    - 6: WAIT - Advance time to next event
