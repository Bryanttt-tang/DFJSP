...
class PoissonDynamicFJSPEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if self.event_time > machine_available_time or self.event_time > job_ready_time:
            print("Error! ","event_time:", self.event_time, "machine_available_time:", machine_available_time, "job_ready_time:", job_ready_time)
