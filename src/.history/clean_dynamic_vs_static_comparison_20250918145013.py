...
class StaticFJSPEnv(gym.Env):
    ...
    def _get_observation(self):
        ...
        # 5. Job arrival status (all jobs arrived at t=0 for static environment)
        for job_id in self.job_ids:
...
class PerfectKnowledgeFJSPEnv(gym.Env):
    ...
    def _get_observation(self):
        ...
        # 5. Job arrival status (unchanged - this is good for static env)
        for job_id in self.job_ids:
            # All jobs arrived at t=0 in static environment
            obs.append(1.0)
