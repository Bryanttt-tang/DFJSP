...
if __name__ == "__main__":
    ...
    # All methods now use the same consistent arrival times for accurate comparison
    plot_three_method_comparison(schedules_data, arrival_times=consistent_arrival_times, 
