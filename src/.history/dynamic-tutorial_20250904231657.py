...
class FJSPEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if not self._is_valid_action(job_idx, op_idx, machine_idx):
            ...
            return self._get_observation(), -5.0, False, False, {"invalid_action": True, "makespan": self.current_makespan}
...
def compare_methods():
    ...
    # Initialize variables to handle exception case
    milp_taillard_schedule, milp_taillard_makespan = None, 0
    rl_taillard_schedule, rl_taillard_makespan = None, 0
    ...
    return {
        ...
        'taillard_like': {
            ...
            'milp': (milp_taillard_schedule, milp_taillard_makespan) if milp_taillard_schedule else (None, 0),
            'rl': (rl_taillard_schedule, rl_taillard_makespan) if rl_taillard_schedule else (None, 0)
        }
    }
