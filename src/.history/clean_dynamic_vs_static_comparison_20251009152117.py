...
def plot_training_metrics():
    ...
    if TRAINING_METRICS['action_entropy']:
        ...
        loss_rollouts = rollout_numbers[:len(entropy_loss)]
        
        axes[2, 0].plot(loss_rollouts, entropy_loss, 'orange', linewidth=2, alpha=0.7, label='Entropy Loss')
        axes[2, 0].legend()
    ...
    if TRAINING_METRICS['episode_lengths']:
        ...
        axes[2, 1].plot(length_rollouts, ep_lengths, 'teal', linewidth=2, alpha=0.7, label='Mean Episode Length')
        axes[2, 1].legend()
        
        axes[2, 1].set_xlabel('Rollout Number')
        axes[2, 1].set_ylabel('Mean Episode Length')
        axes[2, 1].set_title('Mean Episode Length (Steps per Episode)')
