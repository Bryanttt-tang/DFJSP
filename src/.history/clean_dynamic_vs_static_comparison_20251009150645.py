...
def plot_training_metrics():
    ...
    rewards = TRAINING_METRICS['rollout_ep_rew_mean']
    episode_timesteps = TRAINING_METRICS['timesteps'][:num_episodes] if 'episode_timesteps' in TRAINING_METRICS else list(range(num_episodes))
