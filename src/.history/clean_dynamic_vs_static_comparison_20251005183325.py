...
class PoissonDynamicFJSPEnv(gym.Env):
    ...
    EVENT-DRIVEN: Separate event_time (for arrivals) from makespan (for schedule).
    """
    ...
    def _reset_state(self):
        ...
        # FIXED EVENT-DRIVEN: Separate event_time from makespan
        self.event_time = 0.0      # Event frontier - controls arrival visibility and WAIT
        self.current_makespan = 0.0  # Schedule bookkeeping - max end time of scheduled ops
        ...
        # Update arrived jobs based on initial event_time (0.0)
        self._update_arrived_jobs()

    def _update_arrived_jobs(self):
        """Update arrived jobs based on current event_time (not makespan)."""
        newly_arrived = []
