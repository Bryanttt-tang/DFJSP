...
def evaluate_dynamic_on_dynamic(dynamic_model, jobs_data, machine_list, arrival_times, reward_mode="makespan_increment"):
    """Evaluate dynamic model on dynamic scenario - FIXED VERSION."""
    print(f"  Dynamic RL using arrival times: {arrival_times}")
    
    # Use PerfectKnowledgeFJSPEnv instead of PoissonDynamicFJSPEnv for consistent evaluation
    # This ensures the arrival times are deterministic and match exactly what we specify
