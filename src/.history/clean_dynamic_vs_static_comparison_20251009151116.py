...
def plot_training_metrics():
    ...
    # Plot 4: Value Loss over Rollouts (Middle Right)
    if TRAINING_METRICS['value_loss']:
        value_loss = TRAINING_METRICS['value_loss'][:num_rollouts]  # Ensure same length
        
        axes[1, 1].plot(rollout_numbers, value_loss, 'b-', linewidth=2, alpha=0.7, label='Value Loss')
        axes[1, 1].legend()
