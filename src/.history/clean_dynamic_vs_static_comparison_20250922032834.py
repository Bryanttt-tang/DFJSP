...
def main():
    ...
    print("OPTIMIZED: Switched to event-driven observation space with informational hierarchy:")
    print("       - Static RL (31 elements): Ready jobs + Machine status + Processing times")
    print("       - Dynamic RL (38 elements): + Future arrival time hints for unarrived jobs")
    print("       - Perfect RL (59 elements): + Exact arrival times + Future processing times")
