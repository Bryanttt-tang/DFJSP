...
def main():
    ...
    # Use first test scenario for all evaluations (Poisson arrivals)
    ...
    # Static RL on Poisson scenario (disadvantaged - assumes all jobs at t=0)
    print("Evaluating Static RL on Poisson scenario...")
    ...
    # Dynamic RL on Poisson scenario (advantaged - knows arrival distribution)
    print("Evaluating Dynamic RL on Poisson scenario...")
