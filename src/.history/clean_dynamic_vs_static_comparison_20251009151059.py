...
def plot_training_metrics():
    ...
    # Plot 2: Total Loss over Rollouts (Top Right)
    if TRAINING_METRICS['total_loss']:
        total_loss = TRAINING_METRICS['total_loss'][:num_rollouts]  # Ensure same length
        
        axes[0, 1].plot(rollout_numbers, total_loss, 'purple', linewidth=2, alpha=0.7, label='Total Loss')
        axes[0, 1].legend()
