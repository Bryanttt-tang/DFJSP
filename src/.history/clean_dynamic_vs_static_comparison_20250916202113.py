...
class StaticFJSPEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # Validate action - use softer penalty like test3_backup.py
    ...
    def _calculate_reward(self, proc_time, idle_time, done, previous_time, current_time):
        """Calculate reward for static environment using test3_backup.py approach."""
        if self.reward_mode == "makespan_increment":
            # Use makespan increment approach from test3_backup.py
            ...
            # Positive reward for completing an operation
            reward += 20.0
            
            # Small penalty for processing time
            ...
            if done:
                ...
                if current_time and current_time > 0:
                    reward += max(0, 500.0 / current_time)
