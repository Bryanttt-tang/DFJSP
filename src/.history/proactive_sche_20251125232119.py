...
def main():
    ...
    print("\n1. TRAINING SETUP")
    print("-" * 50)
    perfect_timesteps = 600000    # Perfect knowledge with MULTIPLE INITIALIZATIONS
    ...
    for i, scenario in enumerate(test_scenarios):
        ...
        perfect_model = train_perfect_knowledge_agent(
            ...
            reward_mode="makespan_increment", 
            learning_rate=learning_rate,
            num_initializations=2  # ⭐ Try 5 random initializations # ⭐ Pass MILP for early stopping
        )
        if i == 0:
