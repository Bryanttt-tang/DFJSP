...
def run_heuristic_comparison(jobs_data, machine_list, arrival_times):
    ...
    Tests:
    - Sequencing rules: FIFO, LIFO, SPT, LPT, EDD, MWKR (6 rules)
    - Routing rules: MIN, MINC, LEAST_LOADED (3 rules)
    - Total combinations: 6 × 3 = 18 strategies
    
    This comprehensive comparison finds the best heuristic for the given scenario.
    """
    sequencing_rules = ['FIFO', 'LIFO', 'SPT', 'LPT', 'EDD', 'MWKR']
    routing_rules = ['MIN', 'MINC', 'LEAST_LOADED']
