...
def main():
    ...
    static_makespan, static_schedule, static_arrival_times = evaluate_on_test_scenarios(
        static_model, test_scenarios, ENHANCED_JOBS_DATA, MACHINE_LIST, "Static RL", is_static_model=True)
    
    # Dynamic RL on dynamic scenario
    print("Evaluating Dynamic RL on dynamic scenarios...")
    dynamic_makespan, dynamic_schedule, dynamic_arrival_times = evaluate_on_test_scenarios(
        dynamic_model, test_scenarios, ENHANCED_JOBS_DATA, MACHINE_LIST, "Dynamic RL", is_static_model=False)
    
    # SPT Heuristic on dynamic scenario
    print("Evaluating SPT Heuristic on dynamic scenarios...")
    # Use the first test scenario for SPT
    ...
    colors = plt.cm.tab20.colors
    schedules_data = [
        {'schedule': dynamic_schedule, 'makespan': dynamic_makespan, 'title': 'Dynamic RL', 'arrival_times': dynamic_arrival_times},
        {'schedule': static_schedule, 'makespan': static_makespan, 'title': 'Static RL', 'arrival_times': static_arrival_times},
