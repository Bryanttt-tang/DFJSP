...
class PoissonDynamicFJSPEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # CRITICAL: Include event_time to prevent scheduling in the past
        ...
        # DO NOT auto-advance event_time after scheduling - let agent control via WAIT action
        # The agent should explicitly WAIT to reveal new jobs, not auto-advance
