...
def main():
    ...
    print("\n1. TRAINING SETUP")
    print("-" * 50)
    perfect_timesteps = 250000    # Perfect knowledge needs less training
    dynamic_timesteps = 250000   # Increased for better learning with integer timing  
    static_timesteps = 250000    # Increased for better learning
